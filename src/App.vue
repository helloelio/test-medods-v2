<template>
  <div id="app">
      ...
      <div class="person-info">
        <div class="left-block">
          <label for="lastName"
            ...
            <p
              class="error-message"
              v-show="$v.person.lastName.$error && $v.person.lastName.$invalid"
            >
          ...
          <label for="name"
            ...
            <p
              class="error-message"
              v-show="$v.person.name.$error && $v.person.name.$invalid"
            >
        ...
        <div class="right-block">
          <label for="clientGroup"
            ...
            <p
              class="error-message"
              v-show="
                $v.person.clientGroup.$error && $v.person.clientGroup.$invalid
              "
            >
      ...
      <div class="adress-info">
        ...
        <label for="city"
          ...
          <p
            class="error-message"
            v-show="
              $v.person.adress.city.$error && $v.person.adress.city.$invalid
            "
          >
      ...
      <div class="document-info">
        <label for="document">
          ...
          <p
            class="error-message"
            v-show="
              $v.person.document.type.$error && $v.person.document.type.$invalid
            "
          >
        ...
        <label for="dateOfIssue"
          ...
          <p
            class="error-message"
            v-show="
              $v.person.document.dateOfIssue.$invalid &&
    ...
    <div v-else class="congratulations">Регистрация прошла успешно</div>
  </div>
</template>
